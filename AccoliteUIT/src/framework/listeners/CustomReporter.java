...
public class CustomReporter implements IReporter {
	...
	public  void sendEmail() throws Exception{
         ...
         properties.setProperty("mail.smtp.user",this.cutitlitis.getEmailProperty("fromAddress").trim());
         properties.setProperty("mail.smtp.password", this.cutitlitis.getEmailProperty("password").trim());
